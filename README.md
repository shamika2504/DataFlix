...
├── DataCleaning.ipynb            # Data cleaning and CPI adjustment
...
These visualizations were first prototyped in Jupyter notebooks and later integrated into the Streamlit dashboard.
...
```bash
git clone https://github.com/shamika2504/DataFlix.git
cd DataFlix
